...
[ooc][b]OUT OF CHARACTER[/b][/ooc]

16. Overall Mindset
[b]RATING:[/b] ${params.overallMindset_rating || ""}
[b]EXPLANATION FOR RATING:[/b] ${params.overallMindset_explanation || ""}

17. Character Portrayal
[b]RATING:[/b] ${params.characterPortrayal_rating || ""}
[b]EXPLANATION FOR RATING:[/b] ${params.characterPortrayal_explanation || ""}

18. Passive Roleplay
[b]RATING:[/b] ${params.passiveRoleplay_rating || ""}
[b]EXPLANATION FOR RATING:[/b] ${params.passiveRoleplay_explanation || ""}
